...
class Animation:
    ...
    def frombytes(cls, octets):
        ...
        i = 0
        while not is_last:
            octets_slice = octets[header_size + i * segment_size:header_size + (i + 1) * segment_size]
            segment_unknown, repeat, body_part, is_last, padding, start, end = unpack(segment_format, octets_slice)
